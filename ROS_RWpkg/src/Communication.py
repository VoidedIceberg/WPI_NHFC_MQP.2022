...
import serial
import serial.rs485
from RosDataHandler import RosDataHandler
...
if __name__ == "__main__":
    ...
    while True:
        ...
        V_R = np.round((-0.0017 * ty ** 2 + 0.3953 * ty - 1.7699) / 1.0, 2)
        V_L = np.round((-0.0017 * fy ** 2 + 0.3953 * fy - 1.7699) / 1.0, 2)
        ''''''
